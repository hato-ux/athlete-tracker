...
const emptyRecord = () => ({
  ...
  snacks:[], practice:"", memo:"", pain:[], throwingStatus:"", saved:false,
});
...
function TopScreen({ onPlayer, onCoach }) {
  return (
    <div style={{minHeight:"100vh",background:"#1c3a1c",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:24,fontFamily:"'Noto Sans JP',sans-serif",position:"relative",overflow:"hidden"}}>
      ...
      <div style={{fontFamily:"Anton,sans-serif",fontSize:34,color:"#f0e68c",letterSpacing:4,marginBottom:4}}>関学大附</div>
      <div style={{fontFamily:"'Noto Sans JP',sans-serif",fontSize:18,color:"rgba(255,255,255,.8)",letterSpacing:3,marginBottom:48,fontWeight:700}}>コンディショニング</div>
      ...
      <div className="hdr-navy">
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-end"}}>
          <div>
            ...
            <div style={{fontFamily:"'Noto Sans JP',sans-serif",fontSize:20,color:"#ffd700",letterSpacing:1,fontWeight:900}}>指導者ビュー</div>
          </div>
      ...
      {confirmDelete && (
        <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1000,padding:20}}>
          <div style={{background:"#fff",borderRadius:16,padding:24,maxWidth:320,width:"100%",textAlign:"center"}}>
            ...
            <div style={{fontSize:12,color:"#888",marginBottom:20}}>選手情報と全記録が完全に削除されます。この操作は元に戻せません。</div>
            <div style={{display:"flex",gap:10}}>
        ...
        {confirmDelRec && (
          <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.6)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1000,padding:20}}>
            <div style={{background:"#fff",borderRadius:16,padding:24,maxWidth:320,width:"100%",textAlign:"center"}}>
              ...
              <div style={{fontSize:12,color:"#888",marginBottom:20}}>この操作は元に戻せません。</div>
              <div style={{display:"flex",gap:10}}>
          ...
          <div style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,.7)",zIndex:500,display:"flex",alignItems:"flex-end",justifyContent:"center"}}
            ...
            <div style={{background:"#f5f0e8",borderRadius:"20px 20px 0 0",padding:"20px 18px 40px",width:"100%",maxWidth:480,maxHeight:"75vh",overflowY:"auto"}}
              ...
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
                ...
                <button onClick={()=>setSelectedDate(null)} style={{background:"none",border:"none",fontSize:22,cursor:"pointer",color:"#888"}}>×</button>
              </div>
              {(()=>{
                ...
                return <>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
                    {[["⚖️ 体重",r.weight,"kg"],["🌙 睡眠",r.sleep,"h"],["⚾ 練習",r.practice,"h"],["🍽 摂取",kcal||"","kcal"]].map(([lbl,val,unit])=>(
